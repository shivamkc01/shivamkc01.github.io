...
- Some of my alt-text descriptions are too long! 😆 I'll use this example to highlight some of the super helpful features of the WAVE tool. Below is a screenshot of the tool when I select the alert next to the super long alt-text description for a hex logo 🤦‍♀️
    ...
    ![Reference pane of the tool elaborates on what the alert means, why it matters, how to fix it, a note on the tool's algorithm, and a link to the WCAG standards and guidelines. Code section is expanded along the bottom and highlights exactly what part of the HTML code the alert is refering to.](img/wave-ex-alt-text.png){fig-alt="Reference pane of the tool elaborates on what the alert means, why it matters, how to fix it, a note on the tool's algorithm, and a link to the WCAG standards and guidelines. Code section is expanded along the bottom and highlights exactly what part of the HTML code the alert is refering to."}
    </details>
...
![Figure 1: Audit for my home page](img/wave-home.png){fig-alt="There is an error symbol next to the decorative image on the home page. There are also alert symbols for links in the navigation bar and footer."}
...
![Figure 2: Audit for my About page header](img/wave-about-header.png){fig-alt="About page showing an alert in my blurb"}

![Figure 3: Audit for the main section of my About page](img/wave-about-main-top.png){fig-alt="An alert is shown next to some heading items, and a link. An error is shown next to a thumbnail image for the featured blog post"}

<details><summary>Full page screenshot</summary>

![Figure 4: Audit for my About page in full page view](img/wave-about.png){fig-alt="Alerts are shown for links in the navigation bar and footer, for some heading items, and for a few links throughout the page"}
...
![Figure 5: Audit for my Blog listing page in full page view](img/wave-blog.png){fig-alt="Alerts are shown for the navigation bar and footer, and for blog post links. Errors shown for the decorative image for the page and for the blog post thumbnails."}

### Blog example

Link: [https://silvia.rbind.io/blog/hello-hugo-apero/](/blog/2021-hello-hugo-apero/)
...
![Alerts shown for links in the navigation bar and for a heading item. Errors shown for the blog decorative image and for a link symbol next to a header.](img/wave-blog-hha-top.png){fig-alt="Figure 6: Audit for my Hello Hugo Apéro blog post"}
...
![Figure 7: Audit for my Talk listing page](img/wave-talks-top.png){fig-alt="Alerts displayed for a heading item and the primary link to a talk. An error is displayed for the talk thumbnail."}

<details><summary>Full page screenshot</summary>

![Figure 8: Audit for my About page header in full page view](img/wave-talks.png){fig-alt="Alerts displayed in the navigation bar and footer, some heading items, all primary talk links, and a YouTube button link. Errors displayed for all talk thumbnail images."}

</details>

### Talk example

Link: [https://silvia.rbind.io/talk/2021-data-viz-accessibility/](/talk/2021-data-viz-accessibility/)
...
![Figure 9: Audit for my CSV Conf talk post in full page view](img/wave-talks-csvconf.png){fig-alt="Alerts displayed for the navigation bar and footer, as well as the talk summary. No errors are displayed."}
...
![Figure 10: Audit for my Publication listing page](img/wave-pubs-top.png){fig-alt="No errors or alerts displayed for this view"}

<details><summary>Full page screenshot</summary>

![Alerts displayed for the navigation bar and footer](img/wave-pubs.png){fig-alt="Figure 11: Audit for my Publication listing page in full page view"}

</details>

### Publication example

Link: [https://silvia.rbind.io/publication/2021-geospatial-analysis-pregnancy-outcomes/](/publication/2021-geospatial-analysis-pregnancy-outcomes/)
...
![Figure 12: Audit for my geospatial analysis publication in full page view](img/wave-pubs-geo.png){fig-alt="Alerts displayed for the header bar and footer and for the publication summary"}
...
![Figure 13: Audit for my Project listing page](img/wave-projects-top.png){fig-alt="Errors displayed next to each project thumbnail image"}

### Project example

Link: [https://silvia.rbind.io/project/2021-tidy-tuesday-alt-text/](/project/2021-tidy-tuesday-alt-text/)
...
![Figure 14: Audit for my TidyTuesdayAltText project post](img/wave-projects-ttat-top.png){fig-alt="Alert displayed in the project summary and next to an image alt-text. Error dislayed next to a link symbol accompanying a heading."}

<details><summary>Full page screenshot</summary>

![Figure 15: Audit for my TidyTuesdayAltText project post in full page view](img/wave-projects-ttat.png){fig-alt="Alerts shown in the navigation bar and footer, project summary, and image alt-text. Errors shown next to link symbols accompanying headings."}
